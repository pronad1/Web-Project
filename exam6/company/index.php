                        ...
                        <div class="row">
                                    ...
                                    <div>
                                        <ul>
                                            ...
                                            <li><a href="create-job-post.php"><i class="fa fa-file-o"></i> Create Job
                                                    Post</a></li>
                                            <li><a href="my-job-post.php"><i class="fa fa-file-o"></i> My Job Post</a>
                                            </li>
                            ...
                            <div class="col-md-9 bg-white padding-2">
                                ...
                                <div class="alert alert-info alert-dismissible">
                                    <i class="icon fa fa-info"></i> In this dashboard you are able to change your
                                    account
                                    settings, post and manage your jobs. Got a question? Do not hesitate to drop us a
                                    mail.
                                </div>
