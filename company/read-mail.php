                      ...
                      <div class="box-body no-padding">
                        <div class="mailbox-read-info">
                          ...
                          <h5>From:
                            ...
                            <span
                              class="mailbox-read-time pull-right"><?php echo date("d-M-Y h:i a", strtotime($row['createdAt'])); ?></span>
                          </h5>
                        </div>
                      ...
                      <div class="box-body no-padding">
                        <div class="mailbox-read-info">
                          ...
                          <h5>From:
                            ...
                            <span
                              class="mailbox-read-time pull-right"><?php echo date("d-M-Y h:i a", strtotime($rowReply['createdAt'])); ?></span>
                          </h5>
                        </div>
                        <div class="mailbox-read-message">
...
?>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2025 <a href="jonsnow.netai.net">Job Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
