...
INSERT INTO `company` (`id_company`, `name`, `companyname`, `country`, `state`, `city`, `contactno`, `website`, `email`, `password`, `createdAt`) VALUES
(2, 'Prosenjit Mondol', 'cse', 'Bangladesh', '', '', '1315747034', 'https://pronad1.github.io/Personal-Portfolio/', 'prosenjit1156@gmail.com', 'YWJlYzA3NjY3ZjI0ZTE5MTg1NzRhNjkxZmI3NmM5NWI=', '2025-04-29 04:47:52'),
(3, 'Saikat mondal', 'Alibaba', 'Bangladesh', '', '', '1328305031', 'https://pronad1.github.io/Personal-Portfolio/', 'saikatmondalnaogaon@gmail.com', 'YWJlYzA3NjY3ZjI0ZTE5MTg1NzRhNjkxZmI3NmM5NWI=', '2025-05-16 15:07:55');

--
-- Triggers `company`
--
DELIMITER $$
CREATE TRIGGER `company_profile_audit` BEFORE UPDATE ON `company` FOR EACH ROW BEGIN
    IF OLD.companyname != NEW.companyname THEN
        INSERT INTO profile_audit_log (entity_type, entity_id, field_name, old_value, new_value, change_by)
        VALUES ('company', OLD.id_company, 'companyname', OLD.companyname, NEW.companyname, NEW.email);
    END IF;
    
    IF OLD.email != NEW.email THEN
        INSERT INTO profile_audit_log (entity_type, entity_id, field_name, old_value, new_value, change_by)
        VALUES ('company', OLD.id_company, 'email', OLD.email, NEW.email, NEW.email);
    END IF;
END
$$
DELIMITER ;
...
(9, 2, 'software engineering', 'At google ', '1111', '111111', '1', '11', '2025-04-29 07:17:14'),
(10, 2, 'software engineering', 'Networking', '10000', '100000', '1', '11', '2025-04-29 09:28:48'),
(11, 2, 'developer', 'full time', '1111', '111111', '11', '111', '2025-04-29 14:10:57'),
(12, 2, 'Marketing ', 'Increasing Revenue  ', '40000', '95000', '2', 'High, Medium', '2025-05-19 20:39:07');

-- --------------------------------------------------------

--
-- Table structure for table `profile_audit_log`
--

CREATE TABLE `profile_audit_log` (
  `id` int(11) NOT NULL,
  `entity_type` enum('candidate','company') NOT NULL,
...
--
-- Dumping data for table `profile_audit_log`
--

INSERT INTO `profile_audit_log` (`id`, `entity_type`, `entity_id`, `field_name`, `old_value`, `new_value`, `change_date`, `change_by`) VALUES
(1, 'candidate', 2, 'lastname', 'Mondol', 'Kumar', '2025-05-16 14:15:14', 'prosenjit1156@gmail.com'),
(2, 'candidate', 2, 'lastname', 'Kumar', 'mondol', '2025-05-16 14:25:43', 'prosenjit1156@gmail.com'),
(3, 'candidate', 3, 'lastname', 'mondal', 'kumar', '2025-05-16 14:41:21', 'saikatmondalnaogaon@gmail.com');
...
INSERT INTO `reviews` (`id_review`, `id_user`, `id_company`, `id_jobpost`, `rating`, `review_text`, `review_date`) VALUES
(1, 2, NULL, 12, 4, '3', '2025-05-19 21:35:42'),
(2, 2, NULL, 11, 5, '4', '2025-05-19 21:35:51'),
(3, 2, NULL, 11, 5, '5', '2025-05-19 21:35:55'),
(4, 2, NULL, 11, 5, '3', '2025-05-19 21:36:04'),
(5, NULL, 2, 12, 5, '4', '2025-05-19 21:37:32'),
(6, NULL, 2, 11, 5, '5', '2025-05-19 21:37:38'),
(7, NULL, 2, 12, 5, '4', '2025-05-19 21:37:43'),
(8, NULL, 2, 12, 5, '5', '2025-05-19 21:37:47');
...
INSERT INTO `users` (`id_user`, `firstname`, `lastname`, `email`, `password`, `skills`, `state`) VALUES
(2, 'Prosenjit', 'mondol', 'prosenjit1156@gmail.com', 'YWJlYzA3NjY3ZjI0ZTE5MTg1NzRhNjkxZmI3NmM5NWI=', 'php, html, css', 'Rajshahi'),
(3, 'Saikat', 'kumar', 'saikatmondalnaogaon@gmail.com', 'YWJlYzA3NjY3ZjI0ZTE5MTg1NzRhNjkxZmI3NmM5NWI=', 'abc', 'Rajshahi');

--
-- Triggers `users`
--
DELIMITER $$
CREATE TRIGGER `candidate_profile_audit` BEFORE UPDATE ON `users` FOR EACH ROW BEGIN
    IF OLD.firstname != NEW.firstname THEN
        INSERT INTO profile_audit_log (entity_type, entity_id, field_name, old_value, new_value, change_by)
        VALUES ('candidate', OLD.id_user, 'firstname', OLD.firstname, NEW.firstname, NEW.email);
    END IF;
    
    IF OLD.lastname != NEW.lastname THEN
        INSERT INTO profile_audit_log (entity_type, entity_id, field_name, old_value, new_value, change_by)
        VALUES ('candidate', OLD.id_user, 'lastname', OLD.lastname, NEW.lastname, NEW.email);
    END IF;
    
    IF OLD.email != NEW.email THEN
        INSERT INTO profile_audit_log (entity_type, entity_id, field_name, old_value, new_value, change_by)
        VALUES ('candidate', OLD.id_user, 'email', OLD.email, NEW.email, NEW.email);
    END IF;
END
$$
DELIMITER ;
...
ALTER TABLE `apply_job_post`
  ...
  ADD KEY `fk_apply_jobpost` (`id_jobpost`),
  ADD KEY `fk_apply_company` (`id_company`),
  ADD KEY `fk_apply_user` (`id_user`);
...
--
-- Indexes for table `profile_audit_log`
--
...
--
ALTER TABLE `job_post`
  MODIFY `id_jobpost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `profile_audit_log`
--
ALTER TABLE `profile_audit_log`
...
--
ALTER TABLE `apply_job_post`
  ADD CONSTRAINT `fk_apply_company` FOREIGN KEY (`id_company`) REFERENCES `company` (`id_company`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_apply_jobpost` FOREIGN KEY (`id_jobpost`) REFERENCES `job_post` (`id_jobpost`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_apply_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON UPDATE CASCADE;
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE SET NULL,
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`id_company`) REFERENCES `company` (`id_company`) ON DELETE SET NULL,
  ADD CONSTRAINT `reviews_ibfk_3` FOREIGN KEY (`id_jobpost`) REFERENCES `job_post` (`id_jobpost`) ON DELETE SET NULL;

--
-- Constraints for table `states`
--
ALTER TABLE `states`
  ADD CONSTRAINT `fk_state_country` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`);
COMMIT;
