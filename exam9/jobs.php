      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 latest-job margin-bottom-20">
            <?php
                $sql = "SELECT job_post.*, company.* FROM job_post INNER JOIN company ON job_post.id_company = company.id_company ORDER BY RAND() LIMIT 4";
                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="job-meta" style="margin-bottom:8px;">
                      <span><i class="fa fa-building"></i>
                        <?php echo htmlspecialchars($row['companyname']); ?></span>
                      &nbsp;|&nbsp;
                    ...
                    <div class="rating-form">
                      <form method="POST" action="add-review.php" class="form-inline">
                        ...
                        <div class="form-group">
                          <input type="text" name="review" class="form-control input-sm" placeholder="Write a review"
                            required>
                        </div>
